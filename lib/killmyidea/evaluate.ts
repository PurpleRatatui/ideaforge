...
import { CATEGORIES, DECISION_COUNT, DEFAULT_GOAL, dimensionsFor, isGoal, type Goal } from './questions'
import { averageScore, LOW_CLARITY_WARNING, normalizeScore, SCORING_VERSION } from './scoring'
import { readChoice, readNoul, readScore, type SystemOneResponse } from './typesafe'
