  ...
  return (
    <div className="site-shell">
      ...
      <header className="site-header wrap">
        <a className="wordmark" href="/roaster" aria-label="Idea Roaster home"><span className="brand-icon"><Flame size={23} fill="currentColor" /></span>idea<span className="brand-light">forge</span><span className="brand-period">.</span></a>
        <nav aria-label="Main navigation"><a href="/">She Is Solana</a><a href="#how-it-works">How it works</a><button onClick={showExample} disabled={loading}>See an example <ArrowRight size={15}/></button></nav>
      </header>
      <main>
